...
load(file = "data1.RData") # Can be used if you run code separately in .r file, save Env as data1.Rdata (knitting is slow)
```
...
```{r random_forests_threshold, include=FALSE, eval=TRUE}

...
label variable EMRED "Does your ED use an electronic health record (EHR) system? Do not including billing systems."
...
label variable AMBDIV "Did your ED go on ambulance diversion in 2018?"
label variable TOTHRDIVR "What is the total number of hours that your hospital's ED was on ambulance diversion in 2018?"
...
label define AMBDIVF 1 "Hospital's ED went on ambulance diversion in 2018" , add
label define AMBDIVF 2 "Hospital's ED did not go on diversion in 2018" , add
...
label define LOSF -9 "Blank"  
label define LOSF -7 "Not Applicable" , add
label define LOSF 99 "99 days or more" , add
...
label define MEDCODF 16126 "NEO-SYNEPHRINE OPHTHALMIC SOLUTION" , add
...
label define MEDCODF 16146 "DEPADE" , add
...
label define MEDCODF 16230 "RILPIVIRINE" , add
label define MEDCODF 16231 "LEDIPASVIR-SOFOSBUVIR" , add
label define MEDCODF 16238 "BACILLUS COAGULANS" , add
label define MEDCODF 16244 "DEFERASIROX" , add
label define MEDCODF 16247 "FORMOTEROL-GLYCOPYRROLATE" , add
label define MEDCODF 16257 "SODIUM FLUORIDE F-18" , add
label define MEDCODF 16258 "FERRIC CITRATE" , add
label define MEDCODF 16274 "ORBACTIV" , add
label define MEDCODF 16275 "PRUCALOPRIDE" , add
label define MEDCODF 16276 "RETACRIT" , add
...
label define MEDCODF 70078 "CANNABIS" , add
...
label define RFV3DF 5935 "Systemic inflammatory response syndrome (SIRS)" , add
...
label define RFVF 59350 "Systemic inflammatory response syndrome (SIRS), unspecified" , add
label define RFVF 59352 "Severe sepsis" , add
label define RFVF 59354 "Systemic inflammatory response syndrome due to noninfect process..." , add
...
label define TOTHRDIVRF -6 "Refused to answer" , add

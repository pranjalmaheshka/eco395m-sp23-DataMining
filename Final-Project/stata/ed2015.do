...
label variable INJPOISADR1 "Is visit related to an injury/trauma, overdose/poisoning or adverse effect of medical/surgical treatment?  - recode #1"
label variable INJPOISADR2 "Is visit related to an injury/trauma, overdose/poisoning or adverse effect of medical/surgical treatment?  - recode #2"
...
label variable CAUSE1 "Cause #1 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - detailed category"
label variable CAUSE2 "Cause #2 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - detailed category"
label variable CAUSE3 "Cause #3 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - detailed category"
label variable CAUSE13D "Cause #1 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - broader category"
label variable CAUSE23D "Cause #2 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - broader category"
label variable CAUSE33D "Cause #3 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - broader category"
label variable CAUSE1R "Cause #1 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - numeric recode"
label variable CAUSE2R "Cause #2 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment - numeric recode"
label variable CAUSE3R "Cause #3 of injury/trauma, overdose/poisoning, or adverse effect  of medical/surgical treatment  - numeric recode"
...
label variable BMP "Basic metabolic panel"
...
label variable CMP "Comprehensive metabolic panel"
...
label variable DIFFEHRE "Does your EHR have the capability to electronically send health information to another provider whose EHR system is different from your system?"
label variable EHRINSE "Does your ED have plans for installing a new EHR/EMR system within the next 18 months?"
label variable EDEMOGE "Does your ED have the computerized capability for recording patient history and demographic information?"
label variable EDEMOGER "Recode of EDEMOGE for trending with data prior to 2010"
label variable EPROLSTE "If yes to EDEMOGE, does this include a patient problem list?"
label variable EPROLSTER "Recode of EPROLSTE for trending with data prior to 2010"
label variable EVITALE "Does your ED have the computerized capability for recording and charting vital signs?"
label variable EVITALER "Recode of EVITALE for trending with data prior to 2010"
label variable ESMOKEE "Does your ED have the computerized capability for recording patient smoking status?"
label variable ESMOKEER "Recode of ESMOKEE for trending with data prior to 2010"
label variable EPNOTESE "Does your ED have the computerized capability for recording clinical notes?"
label variable EPNOTESER "Recode of EPNOTESE for trending with data prior to 2010"
label variable EMEDALGE "Does your ED have the computerized capability for recording patient's medications and allergies?"
label variable EMEDALGER "Recode of EMEDALGE for trending with data prior to 2010"
label variable EMEDIDE "Does your ED have the computerized capability for reconciling lists of patients' medications to identify the most accurate list?"
label variable EMEDIDER "Recode of EMEDIDE for trending with data prior to 2010"
label variable EREMINDE "Does your ED have the computerized capability for providing reminders for guideline-based interventions or screening tests?"
label variable EREMINDER "Recode of EREMINDE for trending with data prior to 2010"
label variable ECPOEE "Does your ED have the computerized capability for ordering prescriptions?"
label variable ECPOEER "Recode of ECPOEE for trending with data prior to 2010"
label variable ESCRIPE "If computerized capability for ordering prescriptions, are prescriptions sent electronically to the pharmacy?"
label variable ESCRIPER "Recode of ESCRIPE for trending with data prior to 2010"
label variable EWARNE "If computerized capability for ordering prescriptions, are warnings of drug interactions or contraindications provided?"
label variable EWARNER "Recode of EWARNE for trending with data prior to 2010"
label variable EFORMULAE "If computerized capability for ordering prescriptions, are drug formulary checks performed?"
label variable EFORMULAER "Recode of EFORMULAE for trending with data prior to 2010"
label variable ECTOEE "Does your ED have the computerized capability for ordering lab tests?"
label variable ECTOEER "Recode of ECTOEE for trending with data prior to 2010"
label variable EORDERE "If computerized capability for ordering lab tests, are orders sent electronically to the lab?"
label variable EORDERER "Recode of EORDERE for trending with data prior to 2010"
label variable ERESULTE "Does your ED have the computerized  capability for viewing lab results?"
label variable ERESULTER "Recode of ERESULTE for trending with data prior to 2010"
label variable EGRAPHE "If yes to ERESULTE, can the EHR/EMR automatically graph a specific patient's lab results over time?"
label variable EGRAPHER "Recode of EGRAPHE for trending with data prior to 2010"
label variable ERADIE "Does your ED have the computerized capability for ordering radiology tests?"
label variable ERADIER "Recode of ERADIE for trending with data prior to 2010"
label variable EIMGRESE "Does your ED have the computerized capability for viewing imaging results?"
label variable EIMGRESER "Recode of EIMGRESE for trending with data prior to 2010"
label variable EPTEDUE "Does your ED have the computerized capability for identifying educational resources for patients' specific conditions?"
label variable EPTEDUER "Recode of EPTEDUE for trending with data prior to 2010"
label variable ECQME "Does your ED have the computerized capability for reporting clinical quantity measures to federal or state agencies (such as CMS or Medicaid)?"
label variable ECQMER "Recode of ECQME for trending with data prior to 2010"
label variable EIDPTE "Does your ED have the computerized capability for identifying patients due for preventive or follow-up care in order to send patients reminders?"
label variable EIDPTER "Recode of EIDPTE for trending with data prior to 2010"
label variable EGENLISTE "Does your ED have the computerized capability for generating list of patients with particular health conditions?"
label variable EGENLISTER "Recode of EGENLISTE for trending with data prior to 2010"
label variable EIMMREGE "Does your ED have the computerized capability for electronic reporting to immunization registries?"
label variable EIMMREGER "Recode of EIMMREGE for trending with data prior to 2010"
label variable ESUME "Does your ED have the computerized capability for providing patients with clinical summaries for each visit?"
label variable ESUMER "Recode of ESUME for trending with data prior to 2010"
label variable EMSGE "Does your ED have the computerized capability for exchanging secure messages with patients?"
label variable EMSGER "Recode of EMSGE for trending with data prior to 2010"
label variable EPTRECE "Does your ED have the computerized capability for providing patients the ability to view online, download or transmit information from their medical record?"
label variable EPTRECER "Recode of EPTRECE for trending with data prior to 2010"
label variable ESHAREE "Does your hospital share any patient health information electronically (not fax) with other providers, including hospitals, ambulatory providers, or labs?"
label variable ESHAREEHRE "How do you electronically share patient health information? - EHR/EMR"
label variable ESHAREWEBE "How do you electronically share patient health information? - Web portal (separate from EHR/EMR)"
label variable ESHAREOTHE "How do you electronically share patient health information? - Other electronic methods"
label variable ESHAREUNKE "How do you electronically share patient health information? - Unknown"
label variable ESHAREREFE "How do you electronically share patient health information? - Refused to answer"
label variable EHRTOEHRE "Is the patient health information that you share electronically sent directly from your EHR system to another EHR system?"
...
label variable EOUTINFOE "Are you able to electronically find health information (e.g. medications, outside encounters) from sources outside of the hospital for your patients?"
label variable EOUTHOWE1 "How do you look up patient health information from sources outside your hospital? - Through your EHR/EMR"
label variable EOUTHOWE2 "How do you look up patient health information from sources outside your hospital? - Web portal"
label variable EOUTHOWE3 "How do you look up patient health information from sources outside your hospital? - View only or restricted access to other providers' EHR systems"
label variable EOUTHOWE4 "How do you look up patient health information from sources outside your hospital? - Other electronic method (not fax)"
label variable EOUTHOWUNK "How do you look up patient health information from sources outside of the office? - Unknown"
label variable EOUTHOWREF "How do you look up patient health information from sources outside of the office? - Refused"
label variable EOUTYPE1 "What types of information do you routinely look up? - Lab results"
label variable EOUTYPE2 "What types of information do you routinely look up? - Imaging reports"
label variable EOUTYPE3 "What types of information do you routinely look up? - Patient problem lists"
label variable EOUTYPE4 "What types of information do you routinely look up? - Medication lists"
label variable EOUTYPE5 "What types of information do you routinely look up? - Other"
label variable EOUTYPUNK "What types of information do you routinely look up? - Unknown"
label variable EOUTYPREF "What types of information do you routinely look up? - Refused"
label variable EOUTINCORPE "Do you routinely incorporate the information you look up into your EHR?"
...
label variable MUSTAGE1 "Does your hospital have plans to apply for these [Meaningful Use of Health IT] incentive payments?"
...
label variable AMBDIV "Did your ED go on ambulance diversion in 2014?"
label variable TOTHRDIVR "What is the total number of hours that your hospital's ED was on ambulance diversion in 2014?"
...
label define AMBDIVF 1 "Hospital's ED went on ambulance diversion in 2014" , add
label define AMBDIVF 2 "Hospital's ED did not go on diversion in 2014" , add
...
label define EOUTINCORPEF -9 "Blank"  
label define EOUTINCORPEF -8 "Unknown" , add
label define EOUTINCORPEF -7 "Not applicable" , add
label define EOUTINCORPEF -6 "Refused to answer" , add
label define EOUTINCORPEF 1 "Yes, via manual entry or scanned copy" , add
label define EOUTINCORPEF 2 "Yes, automatically able to incorporate without manual entry or scanning" , add
label define EOUTINCORPEF 3 "No, we do not routinely incorporate into our EHR" , add
label define EOUTINFOEF -9 "Blank"  
label define EOUTINFOEF -8 "Unknown" , add
label define EOUTINFOEF -6 "Refused to answer" , add
label define EOUTINFOEF 1 "Yes, routinely" , add
label define EOUTINFOEF 2 "Yes, but not routinely" , add
label define EOUTINFOEF 3 "No" , add
...
label define MEDCODF 15001 "ANACETRAPIB" , add
label define MEDCODF 15004 "ANTICARCINOGENIC AGENT" , add
label define MEDCODF 15005 "HYDROMORPHONE" , add
label define MEDCODF 15006 "ARCAPTA NEOHALER" , add
label define MEDCODF 15008 "ASHLYNA" , add
label define MEDCODF 15011 "AVL-292" , add
label define MEDCODF 15013 "BERBERINE" , add
label define MEDCODF 15014 "B52" , add
label define MEDCODF 15016 "CAPHOSOL" , add
label define MEDCODF 15017 "CODITUSS DM" , add
label define MEDCODF 15018 "ENTYVIO" , add
label define MEDCODF 15019 "GLYXAMBI" , add
label define MEDCODF 15021 "ICLUSIG" , add
label define MEDCODF 15022 "MOVANTIK" , add
label define MEDCODF 15023 "NEXTERONE" , add
label define MEDCODF 15024 "ORKAMBI" , add
label define MEDCODF 15025 "HYDROPHILIC OINTMENT" , add
label define MEDCODF 15026 "XULANE" , add
label define MEDCODF 15027 "ZOHYDRO ER" , add
label define MEDCODF 15030 "DASETTA" , add
label define MEDCODF 15033 "ELINEST" , add
label define MEDCODF 15036 "EMETROL" , add
label define MEDCODF 15037 "ENSKYCE" , add
label define MEDCODF 15038 "EPANED" , add
label define MEDCODF 15040 "HYDROQUINONE" , add
label define MEDCODF 15043 "HYSINGLA ER" , add
label define MEDCODF 15046 "HYOPHEN" , add
label define MEDCODF 15047 "HYPER RHO S/D" , add
label define MEDCODF 15049 "LARIN FE" , add
label define MEDCODF 15051 "MONO-LINYAH" , add
label define MEDCODF 15052 "MONOVISC" , add
label define MEDCODF 15053 "MYZILRA" , add
label define MEDCODF 15054 "NICAZEL FORTE" , add
label define MEDCODF 15056 "ORALONE" , add
label define MEDCODF 15060 "HYDROXOCOBALAMIN" , add
label define MEDCODF 15062 "PRIMLEV" , add
label define MEDCODF 15064 "RIMEXOLONE" , add
label define MEDCODF 15066 "RYTARY" , add
...
label define MEDCODF 15073 "STRIVERDI" , add
label define MEDCODF 15074 "TRIMIX" , add
label define MEDCODF 15076 "XIGDUO XR" , add
label define MEDCODF 15077 "ZENZEDI" , add
label define MEDCODF 15078 "ZYDELIG" , add
...
label define MEDCODF 16008 "HARVONI" , add
...
label values HHSMUE CONTRASTF
label values SECURCHCKE CONTRASTF
label values DIFFEHRE CONTRASTF
label values EMEDRES YESNOUBF
label values EHRTOEHRE EHRTOEHREF
label values EOUTINFOE EOUTINFOEF
label values EOUTHOWE1 EWHOPRACPF
label values EOUTHOWE2 EWHOPRACPF
label values EOUTHOWE3 EWHOPRACPF
label values EOUTHOWE4 EWHOPRACPF
label values EOUTHOWUNK EWHOPRACPF
label values EOUTHOWREF EWHOPRACPF
label values EOUTYPE1 EWHOPRACPF
label values EOUTYPE2 EWHOPRACPF
label values EOUTYPE3 EWHOPRACPF
label values EOUTYPE4 EWHOPRACPF
label values EOUTYPE5 EWHOPRACPF
label values EOUTYPUNK EWHOPRACPF
label values EOUTYPREF EWHOPRACPF
label values EOUTINCORPE EOUTINCORPEF

save ED2015-stata, replace

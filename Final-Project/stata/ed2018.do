...
label variable CTUNK "CT scan - body site unknown"
...
label variable AMBDIV "Did your ED go on ambulance diversion in 2017?"
label variable TOTHRDIVR "What is the total number of hours that your hospital's ED was on ambulance diversion in 2017?"
...
label variable BLANK1 "Placeholder for How many days in a week are inpatient elective surgeries scheduled?"
...
label define AGEF 94 "94 years and over" , add
...
label define AMBDIVF 1 "Hospital's ED went on ambulance diversion in 2017" , add
label define AMBDIVF 2 "Hospital's ED did not go on diversion in 2017" , add
...
label define LOSF 99 "99 days or more"  
...
label define MEDCODF 15003 "ARNUITY ELLIPTA" , add
...
label define MEDCODF 15086 "FYCOMPA" , add
label define MEDCODF 15089 "NINTEDANIB" , add
label define MEDCODF 15090 "HYDROXYUREA" , add
label define MEDCODF 15099 "TOFACITINIB" , add
...
label define MEDCODF 16104 "INSULIN LISPRO" , add
label define MEDCODF 16105 "ISOSORBIDE" , add
label define MEDCODF 16106 "ALOGLIPTIN" , add
label define MEDCODF 16108 "FLUTICASONE FUROATE" , add
label define MEDCODF 16111 "OTOVEL" , add
label define MEDCODF 16112 "EUCRISA" , add
label define MEDCODF 16118 "KEYTRUDA" , add
label define MEDCODF 16122 "NAMZARIC" , add
label define MEDCODF 16124 "LACTOBACILLUS RHAMNOSUS" , add
label define MEDCODF 16128 "TRULANCE" , add
label define MEDCODF 16132 "SACUBITRIL" , add
label define MEDCODF 16134 "OPTICAINE" , add
label define MEDCODF 16136 "AMPICILLIN/SULBACTAM" , add
label define MEDCODF 16139 "SACUBITRIL/VALSARTAN" , add
label define MEDCODF 16141 "TETANUS-DIPTHERIA TOXOIDS-TD" , add
label define MEDCODF 16150 "OSIMERTINIB" , add
label define MEDCODF 16151 "SOLIQUA" , add
label define MEDCODF 16152 "PRODRIN" , add
label define MEDCODF 16153 "FLUOROURACIL CREAM" , add
label define MEDCODF 16154 "ISAVUCONAZONIUM" , add
label define MEDCODF 16155 "TALTZ" , add
label define MEDCODF 16156 "INJECTAFER" , add
label define MEDCODF 16157 "NUCALA" , add
label define MEDCODF 16158 "FLUCAINE" , add
label define MEDCODF 16159 "RHOPRESSA" , add
label define MEDCODF 16161 "VYZULTA" , add
label define MEDCODF 16162 "LYNPARZA" , add
label define MEDCODF 16163 "INGREZZA" , add
label define MEDCODF 16164 "AIMOVIG" , add
label define MEDCODF 16166 "YONDELIS" , add
label define MEDCODF 16167 "TRELEGY ELLIPTA" , add
label define MEDCODF 16168 "RHOFADE" , add
label define MEDCODF 16169 "BIKTARVY" , add
label define MEDCODF 16170 "NEOMYCIN/POLYMYXIN B/PRAMOXINE TOPICAL" , add
label define MEDCODF 16171 "DEUTETRABENAZINE" , add
label define MEDCODF 16172 "BRIVIACT" , add
label define MEDCODF 16173 "GATIFLOXACIN-PREDNISOLONE OPHTHALMIC" , add
label define MEDCODF 16174 "BROMFENAC/GATIFLOXACIN/PREDNISOLONE OPH" , add
label define MEDCODF 16175 "TELAVANCIN" , add
label define MEDCODF 16178 "MYDAYIS" , add
label define MEDCODF 16179 "EPCLUSA" , add
label define MEDCODF 16181 "CLENPIQ" , add
label define MEDCODF 16182 "TREMFYA" , add
label define MEDCODF 16184 "SYNJARDY" , add
label define MEDCODF 16186 "OZEMPIC" , add
label define MEDCODF 16187 "QBREXZA" , add
label define MEDCODF 16188 "SULFACETAMIDE SODIUM TOPICAL" , add
label define MEDCODF 16189 "MOMETASONE TOPICAL" , add
label define MEDCODF 16191 "TEDIZOLID PHOSPHATE" , add
label define MEDCODF 16192 "CANNABIDIOL" , add
label define MEDCODF 16193 "CITRIC ACID-SODIUM CITRATE" , add
label define MEDCODF 16194 "DICLOFENAC-CAPSAICIN" , add
label define MEDCODF 16196 "CLEVIDIPINE" , add
label define MEDCODF 16197 "GADOTERATE MEGLUMINE" , add
label define MEDCODF 16198 "BUPIVACAINE-FENTANYL" , add
label define MEDCODF 16213 "POTASSIUM ACETATE" , add
label define MEDCODF 16214 "EFINACONAZOLE" , add
label define MEDCODF 16216 "BRIDION" , add
label define MEDCODF 16217 "VASOPRESSIN" , add
label define MEDCODF 16218 "DORNASE ALPHA (PULMOZYME)" , add
label define MEDCODF 16219 "DIPHENHYDRAMINE/LIDOCAINE/NYSTATIN TOPI" , add
label define MEDCODF 16221 "CAPSAICIN-MENTHOL TOPICAL" , add
label define MEDCODF 16223 "ACETAMINOPHEN/DEXTROMETHORPHAN/PE" , add
label define MEDCODF 16224 "LIDOCAINE-MENTHOL TOPICAL" , add
label define MEDCODF 16226 "FERRIC CARBOXYMALTOSE" , add
label define MEDCODF 16227 "GAMUNEX-C" , add
label define MEDCODF 16228 "FIDAXOMICIN" , add
...
label values LOS BOARDED WAITTIMEF
label values OBSSTAY WAITTIMEF
label values LOS LOSF

...
opioid_df = rbind(opioid_df, subset(df2013, select = c(VMONTH,VDAYR,YEAR,AGE,RESIDNCE,SEX,ETHUN,RACEUN,
                                                       ...
                                                       INJURY,CAUSE1,NOPROVID,ATTPHYS,RESINT,CONSULT,RNLPN,NURSEPR,    
                                                       PHYSASST,EMT,MHPROV,OTHPROV,LEFTAMA,DIEDED)))  
...
##### Standardized disease variables ICD10 to ICD9
...
remove(df2013,df2014,df2015,df2016,df2017,df2018,df2019,diag12016,diag22016,diag32016,
...
remove(codeine, diag, hydrocodone, icd10toicd9, oxycodone)
